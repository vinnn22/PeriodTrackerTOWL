...
public class AccName extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acc_name);
        ...
        buttonSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name1.isEmpty()) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(AccName.this);
                    ...
                    textViewName.setText("Your name is: " + name1);
                    ...
                    NotificationCompat.Builder builder = new NotificationCompat.Builder(AccName.this, "Account")
                            .setSmallIcon(R.drawable.ic_notification)
                            .setContentTitle("Account Notification")
                            .setContentText("Your name " + name1 + " has been saved successfully!")
                            .setPriority(NotificationCompat.PRIORITY_DEFAULT);

                    NotificationManagerCompat notificationManager = NotificationManagerCompat.from(AccName.this);
